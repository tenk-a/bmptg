...
private:
    ...
    // 中間値を求めるのに用いるパラメータ
    float           ratioLenY_;             ///< Y,U,Vの選択において、予め YをratioLenY_倍してから比較.
    float           ratioLenU_;             ///< Y,U,Vの選択において、予め UをratioLenU_倍してから比較.
    float           ratioLenV_;             ///< Y,U,Vの選択において、予め VをratioLenV_倍してから比較.
