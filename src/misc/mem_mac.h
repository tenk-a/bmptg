...
#define ARGB_FA(argb)       (((uint8_t)((uint32_t)(argb)>>24))* (1/255.f))  ///< argb値よりalphaを 0～1.0FのFloat値として取得.
#define ARGB_FR(argb)       (((uint8_t)((uint32_t)(argb)>>16))* (1/255.f))  ///< argb値よりred  を 0～1.0FのFloat値として取得.
#define ARGB_FG(argb)       (((uint8_t)((uint32_t)(argb)>>8)) * (1/255.f))  ///< argb値よりgreenを 0～1.0FのFloat値として取得.
#define ARGB_FB(argb)       (((uint8_t)(argb))              * (1/255.f))    ///< argb値よりblue を 0～1.0FのFloat値として取得.
